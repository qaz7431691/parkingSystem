...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getSjduochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjduochus?buzhiId=<%=buzhiId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjduochuName" width="40">车牌</th>
				<th field="sjduochuMark" width="20">车主</th>
				<th field="sjduochuMark1" width="60">电话</th>
				<th field="sjduochuZong" width="10">小时</th>
				<th field="sjduochuDouble" width="10">单价</th>
				<th field="sjduochuDouble1" width="10">总额</th>
				<th field="sjduochuDate" width="40" formatter="datetostr">停车</th>
				<th field="sjduochuDate1" width="40" formatter="datetostr">离开</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjduochuAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">停车</a>
			<a href="javascript:shenheSjduochu()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">离开</a>
		</div>
		<div>
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					...
					<td><input class="easyui-combobox" id="shujuId" name="shujuId"  data-options="panelHeight:'auto',editable:false,valueField:'shujuId',textField:'shujuName',url:'../shujuComboList?shujuType=0&buzhiId=<%=buzhiId %>'"/></td>
					<td>车牌：</td>
					<td><input type="text" name="sjduochuName" id="sjduochuName" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>车主：</td>
					<td><input type="text" name="sjduochuMark" id="sjduochuMark" class="easyui-validatebox" required="true"/></td>
					<td>电话：</td>
