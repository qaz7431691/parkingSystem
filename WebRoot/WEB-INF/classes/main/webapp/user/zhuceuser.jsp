...
<div id="login">
        ...
        <div class="main">
            ...
            <ul>
                ...
                <li>车&nbsp;&nbsp;&nbsp;&nbsp;牌：<input class="wa" type="text" name="userMark1" id="userMark1"/></li>
	...
	<script type="text/javascript">
		function check() {
			...
			var regchepai = /^(([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z](([0-9]{5}[DF])|([DF]([A-HJ-NP-Z0-9])[0-9]{4})))|([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z][A-HJ-NP-Z0-9]{4}[A-HJ-NP-Z0-9挂学警港澳使领]))$/;
			if (!regchepai.test(userMark1)) {
				alert('请输入有效的车牌！');
