...
<!--startprint-->
	 ...
	 pagination="true" url="../getSjshaochus?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjshaochuZong" width="10">小时</th>
				<th field="sjshaochuDouble" width="10">元/时</th>
				...
				<th field="sjshaochuMark" width="40">车牌</th>
				<th field="sjshaochuDate" width="40" formatter="datetostr">停车</th>
				<th field="sjshaochuDate1" width="40" formatter="datetostr">离开</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:shenheSjshaochu()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">离开</a>
		</div>
		<div>
