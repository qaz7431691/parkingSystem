...
<div>
	...
	<%=newJcpeizhi.getSjleixingBieming()%>：
	<input class="easyui-combobox" id="sjleixingId" name="sjleixingId"  data-options="panelHeight:'auto',editable:false,valueField:'sjleixingId',textField:'sjleixingName',url:'../sjleixingComboList'"/> 
